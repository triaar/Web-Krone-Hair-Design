...
@section('container')
    <h1 style="text-align: center"> Halaman List Layanan </h1>
    <div class="container">
        <div class="row">
            <div class="col mt-5">
                <a href="admin/add" class="btn btn-warning mt-3">Add</a>
            </div>
        </div>
    </div>
    <table class="table mt-4 table-bordered" border="2" style="text-align: center">
            ...
            <tbody>
                ...
                @foreach ($data as $row)
                    <tr>
                        ...
                        <td>{{ $row->harga }}</td>
                        <td>    
                        <a href="admin/change/{{ $row->id }}" class="">
                        ...
                        <a href="admin/delete/{{ $row->id }}" class="">
